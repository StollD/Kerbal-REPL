...
// Shamelessly stolen from Mono :P
...
namespace Mono.Terminal
{
    public class LineEditor
    {
        ...
        // On Unix, there is a "UTF8" color which is not represented by any colors in
        ...
        void GetUnixConsoleReset()
        {
            ...
            try
            {
                ...
                if (unix_reset_colors_str != null)
                    unix_reset_colors = Encoding.Unicode.GetBytes((string)unix_reset_colors_str);
        ...
        class CompletionState
        {
            ...
            void DrawSelection()
            {
                for (int r = 0; r < Height; r++)
                {
                    ...
                    Console.ForegroundColor = selected ? ConsoleColor.Magenta : ConsoleColor.Black;
